...
if(isset($_POST['checkBoxArray'])){
      ...
      $bulk_options = $_POST['bulk_options'];
        ...
        switch($bulk_options) {
            ...
            case 'approve':  
                ...
                $query = "UPDATE comments SET comment_status = 'approved' WHERE comment_id = $postValueId ";
            ...
            case 'unapprove': 
                ...
                $query = "UPDATE comments SET comment_status = 'unapproved' WHERE comment_id = $postValueId"; 
 ...
 ?>                     
                ...
                $comment_image = $row['comment_image'];
                    ...
                    echo "<td><img width='100' src='../images/$comment_image'alt='image'></td>";
